...
impl SyncEngine {
    ...
    pub fn set_watcher_enabled(&mut self, enabled: bool) {
        self.state.watcher_enabled = enabled;
    }
    ...
    pub fn ensure_dirs_exist(&self) -> Result<(), String> {
    ...
    pub fn copy_to_local(&self, _files: &[&str]) -> Result<(), String> {
    ...
    pub fn _copy_from_local(&self, _files: &[&str]) -> Result<(), String> {
